	...
	int QZint::module_set(int y_coord, int x_coord)
	{
		...
		switch(x_sub) {
			case 0:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x01) != 0) {
					result = 1;
				}
			...
			case 1:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x02) != 0) {
					result = 1;
				}
			...
			case 2:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x04) != 0) {
					result = 1;
				}
			...
			case 3:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x08) != 0) {
					result = 1;
				}
			...
			case 4:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x10) != 0) {
					result = 1;
				}
			...
			case 5:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x20) != 0) {
					result = 1;
				}
			...
			case 6:
				...
				if((m_zintSymbol->encoded_data[y_coord][x_char] & 0x40) != 0) {
					result = 1;
				}
