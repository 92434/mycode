 ...
 * 
 *         cobra 组件是一个 Java HTML Renderer & Parser, 官方网站
...
public class AjaxHttpRequest {
	...
	public static void log(Level level, String msg, Throwable thrown) {
		System.out.println(level.getName() + " : " + thrown.getMessage()
				+ " ----- " + msg);
	}
	 ...
	 */
	public static void testGoogleTranslate(String words, boolean async)
			throws IOException {
		Map params = new HashMap();
		// params.put("hl",words);
		// params.put("hl","zh-CN");
		// params.put("sRef","1:7:1:0:0:0:0:0:0:0:%28type%20==%201%29%20||%20%28type%20==%2017%29%20||%20%28type%20==%20195%29%20||%20%28type%20==%2025%29%20ORDER%20BY%20name");
		String url = "http://192.168.1.37:8001/1:0:1:466:B:58:3120000:0:0:0:";
		// http://192.168.1.37:8001/1:0:1:466:B:58:3120000:0:0:0:
		// http://translate.google.cn/?hl=zh-CN&tab=wT#en/zh-CN/hello%20world
		// http://192.168.1.37/web/getservices?sRef=1:7:1:0:0:0:0:0:0:0:%28type%20==%201%29%20||%20%28type%20==%2017%29%20||%20%28type%20==%20195%29%20||%20%28type%20==%2025%29%20ORDER%20BY%20name
