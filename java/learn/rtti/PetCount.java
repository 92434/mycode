...
public class PetCount {
	...
	public static void main(String[] args) {
		...
		try {
			Class[] petTypes = { Class.forName("rtti.Dog"),
					Class.forName("rtti.Pug"), Class.forName("rtti.Cat"),
					Class.forName("rtti.Rodent"), Class.forName("rtti.Gerbil"),
					Class.forName("rtti.Hamster"), };
			for (int i = 0; i < 15; i++)
