...
//reg [1:28] key_out_l_reg1,       // Delay to accommodate deeper pipe in F
//           key_out_r_reg1;       //
wire [1:28] key_out_l_reg,       // Register for holding intermediate key
           key_out_r_reg;       //   scheduler results
...
//always @( posedge clk )
//begin
//    key_out_r_reg1 <= key_out_r;
//    key_out_l_reg1 <= key_out_l;
//    key_out_l_reg <= key_out_l_reg1;
//    key_out_r_reg <= key_out_r_reg1;
//end
//assign key_out_l_reg = key_out_r;
//assign key_out_r_reg = key_out_l;


///  new, pipelined version
//assign key_out_lr_reg = {key_out_l, key_out_r};
assign key_out_lr_reg = {key_out_r_reg, key_out_l_reg};
