...
set_property PACKAGE_PIN D12 [get_ports {mpeg_clk_in}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_clk_in}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {mpeg_clk_in}]

#FMC_HPC_HA01_CC_P, J94(6)
set_property PACKAGE_PIN H14 [get_ports {mpeg_sync_in}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_sync_in}]

#FMC_HPC_HA05_N, J94(18)
set_property PACKAGE_PIN E16 [get_ports {mpeg_valid_in}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_valid_in}]

#FMC_HPC_HA00_CC_N, J94(7)
set_property PACKAGE_PIN D13 [get_ports {mpeg_data_in}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_data_in}]
...
set_property PACKAGE_PIN H15 [get_ports {mpeg_clk_in_1}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_clk_in_1}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {mpeg_clk_in_1}]

#FMC_HPC_HA16_P, J95(6)
set_property PACKAGE_PIN L15 [get_ports {mpeg_sync_in_1}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_sync_in_1}]

#FMC_HPC_HA20_N, J95(18)
set_property PACKAGE_PIN J13 [get_ports {mpeg_valid_in_1}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_valid_in_1}]

#FMC_HPC_HA15_N, J95(7)
set_property PACKAGE_PIN G15 [get_ports {mpeg_data_in_1}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_data_in_1}]
...
set_property PACKAGE_PIN D17 [get_ports {mpeg_clk_in_2}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_clk_in_2}]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {mpeg_clk_in_2}]

#FMC_HPC_CLK0_M2C_P, J96(6)
set_property PACKAGE_PIN D27 [get_ports {mpeg_sync_in_2}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_sync_in_2}]

#FMC_HPC_LA03_N, J96(18)
set_property PACKAGE_PIN H27 [get_ports {mpeg_valid_in_2}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_valid_in_2}]

#FMC_HPC_CLK1_M2C_N, J96(7)
set_property PACKAGE_PIN D18 [get_ports {mpeg_data_in_2}]
set_property IOSTANDARD LVCMOS25 [get_ports {mpeg_data_in_2}]
