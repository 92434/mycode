...
proc create_root_design { parentCell } {
  ...
  set mpeg_clk_in [ create_bd_port -dir I mpeg_clk_in ]
  set mpeg_clk_in_1 [ create_bd_port -dir I mpeg_clk_in_1 ]
  set mpeg_clk_in_2 [ create_bd_port -dir I mpeg_clk_in_2 ]
  set mpeg_data_in [ create_bd_port -dir I mpeg_data_in ]
  set mpeg_data_in_1 [ create_bd_port -dir I mpeg_data_in_1 ]
  set mpeg_data_in_2 [ create_bd_port -dir I mpeg_data_in_2 ]
  set mpeg_sync_in [ create_bd_port -dir I mpeg_sync_in ]
  set mpeg_sync_in_1 [ create_bd_port -dir I mpeg_sync_in_1 ]
  set mpeg_sync_in_2 [ create_bd_port -dir I mpeg_sync_in_2 ]
  set mpeg_valid_in [ create_bd_port -dir I mpeg_valid_in ]
  set mpeg_valid_in_1 [ create_bd_port -dir I mpeg_valid_in_1 ]
  set mpeg_valid_in_2 [ create_bd_port -dir I mpeg_valid_in_2 ]
  ...
  connect_bd_net -net mpeg_clk_in_1 [get_bd_ports mpeg_clk_in] [get_bd_pins ts_s2p_0/mpeg_clk_in]
  connect_bd_net -net mpeg_clk_in_1_1 [get_bd_ports mpeg_clk_in_1] [get_bd_pins ts_s2p_1/mpeg_clk_in]
  connect_bd_net -net mpeg_clk_in_2_1 [get_bd_ports mpeg_clk_in_2] [get_bd_pins ts_s2p_2/mpeg_clk_in]
  connect_bd_net -net mpeg_data_in_1 [get_bd_ports mpeg_data_in] [get_bd_pins ts_s2p_0/mpeg_data_in]
  connect_bd_net -net mpeg_data_in_1_1 [get_bd_ports mpeg_data_in_1] [get_bd_pins ts_s2p_1/mpeg_data_in]
  connect_bd_net -net mpeg_data_in_2_1 [get_bd_ports mpeg_data_in_2] [get_bd_pins ts_s2p_2/mpeg_data_in]
  connect_bd_net -net mpeg_sync_in_1 [get_bd_ports mpeg_sync_in] [get_bd_pins ts_s2p_0/mpeg_sync_in]
  connect_bd_net -net mpeg_sync_in_1_1 [get_bd_ports mpeg_sync_in_1] [get_bd_pins ts_s2p_1/mpeg_sync_in]
  connect_bd_net -net mpeg_sync_in_2_1 [get_bd_ports mpeg_sync_in_2] [get_bd_pins ts_s2p_2/mpeg_sync_in]
  connect_bd_net -net mpeg_valid_in_1 [get_bd_ports mpeg_valid_in] [get_bd_pins ts_s2p_0/mpeg_valid_in]
  connect_bd_net -net mpeg_valid_in_1_1 [get_bd_ports mpeg_valid_in_1] [get_bd_pins ts_s2p_1/mpeg_valid_in]
  connect_bd_net -net mpeg_valid_in_2_1 [get_bd_ports mpeg_valid_in_2] [get_bd_pins ts_s2p_2/mpeg_valid_in]
