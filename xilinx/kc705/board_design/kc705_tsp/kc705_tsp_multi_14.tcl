...
proc create_root_design { parentCell } {
  ...
  set asi_out_n_8 [ create_bd_port -dir O asi_out_n_8 ]
  set asi_out_n_9 [ create_bd_port -dir O asi_out_n_9 ]
  set asi_out_n_10 [ create_bd_port -dir O asi_out_n_10 ]
  set asi_out_n_11 [ create_bd_port -dir O asi_out_n_11 ]
  set asi_out_n_12 [ create_bd_port -dir O asi_out_n_12 ]
  set asi_out_n_13 [ create_bd_port -dir O asi_out_n_13 ]
  ...
  set asi_out_p_8 [ create_bd_port -dir O asi_out_p_8 ]
  set asi_out_p_9 [ create_bd_port -dir O asi_out_p_9 ]
  set asi_out_p_10 [ create_bd_port -dir O asi_out_p_10 ]
  set asi_out_p_11 [ create_bd_port -dir O asi_out_p_11 ]
  set asi_out_p_12 [ create_bd_port -dir O asi_out_p_12 ]
  set asi_out_p_13 [ create_bd_port -dir O asi_out_p_13 ]
  ...
  set mpeg_clk_8 [ create_bd_port -dir I mpeg_clk_8 ]
  set mpeg_clk_9 [ create_bd_port -dir I mpeg_clk_9 ]
  set mpeg_clk_10 [ create_bd_port -dir I mpeg_clk_10 ]
  set mpeg_clk_11 [ create_bd_port -dir I mpeg_clk_11 ]
  set mpeg_clk_12 [ create_bd_port -dir I mpeg_clk_12 ]
  set mpeg_clk_13 [ create_bd_port -dir I mpeg_clk_13 ]
  ...
  set mpeg_data_8 [ create_bd_port -dir I -from 7 -to 0 mpeg_data_8 ]
  set mpeg_data_9 [ create_bd_port -dir I -from 7 -to 0 mpeg_data_9 ]
  set mpeg_data_10 [ create_bd_port -dir I -from 7 -to 0 mpeg_data_10 ]
  set mpeg_data_11 [ create_bd_port -dir I -from 7 -to 0 mpeg_data_11 ]
  set mpeg_data_12 [ create_bd_port -dir I -from 7 -to 0 mpeg_data_12 ]
  set mpeg_data_13 [ create_bd_port -dir I -from 7 -to 0 mpeg_data_13 ]
  ...
  set mpeg_sync_8 [ create_bd_port -dir I mpeg_sync_8 ]
  set mpeg_sync_9 [ create_bd_port -dir I mpeg_sync_9 ]
  set mpeg_sync_10 [ create_bd_port -dir I mpeg_sync_10 ]
  set mpeg_sync_11 [ create_bd_port -dir I mpeg_sync_11 ]
  set mpeg_sync_12 [ create_bd_port -dir I mpeg_sync_12 ]
  set mpeg_sync_13 [ create_bd_port -dir I mpeg_sync_13 ]
  ...
  set mpeg_valid_8 [ create_bd_port -dir I mpeg_valid_8 ]
  set mpeg_valid_9 [ create_bd_port -dir I mpeg_valid_9 ]
  set mpeg_valid_10 [ create_bd_port -dir I mpeg_valid_10 ]
  set mpeg_valid_11 [ create_bd_port -dir I mpeg_valid_11 ]
  set mpeg_valid_12 [ create_bd_port -dir I mpeg_valid_12 ]
  set mpeg_valid_13 [ create_bd_port -dir I mpeg_valid_13 ]
  ...
  # Create instance: axi4_tsp_8, and set properties
  set axi4_tsp_8 [ create_bd_cell -type ip -vlnv xiaofei:user:axi4_tsp:1.0 axi4_tsp_8 ]

  # Create instance: axi4_tsp_9, and set properties
  set axi4_tsp_9 [ create_bd_cell -type ip -vlnv xiaofei:user:axi4_tsp:1.0 axi4_tsp_9 ]

  # Create instance: axi4_tsp_10, and set properties
  set axi4_tsp_10 [ create_bd_cell -type ip -vlnv xiaofei:user:axi4_tsp:1.0 axi4_tsp_10 ]

  # Create instance: axi4_tsp_11, and set properties
  set axi4_tsp_11 [ create_bd_cell -type ip -vlnv xiaofei:user:axi4_tsp:1.0 axi4_tsp_11 ]

  # Create instance: axi4_tsp_12, and set properties
  set axi4_tsp_12 [ create_bd_cell -type ip -vlnv xiaofei:user:axi4_tsp:1.0 axi4_tsp_12 ]

  # Create instance: axi4_tsp_13, and set properties
  set axi4_tsp_13 [ create_bd_cell -type ip -vlnv xiaofei:user:axi4_tsp:1.0 axi4_tsp_13 ]
  ...
  set_property -dict [ list CONFIG.NUM_MI {17} CONFIG.NUM_SI {1}  ] $axi_interconnect_0
  ...
  # Create instance: kc705_ts2asi_8, and set properties
  set kc705_ts2asi_8 [ create_bd_cell -type ip -vlnv xiaofei:user:kc705_ts2asi:1.0 kc705_ts2asi_8 ]

  # Create instance: kc705_ts2asi_9, and set properties
  set kc705_ts2asi_9 [ create_bd_cell -type ip -vlnv xiaofei:user:kc705_ts2asi:1.0 kc705_ts2asi_9 ]

  # Create instance: kc705_ts2asi_10, and set properties
  set kc705_ts2asi_10 [ create_bd_cell -type ip -vlnv xiaofei:user:kc705_ts2asi:1.0 kc705_ts2asi_10 ]

  # Create instance: kc705_ts2asi_11, and set properties
  set kc705_ts2asi_11 [ create_bd_cell -type ip -vlnv xiaofei:user:kc705_ts2asi:1.0 kc705_ts2asi_11 ]

  # Create instance: kc705_ts2asi_12, and set properties
  set kc705_ts2asi_12 [ create_bd_cell -type ip -vlnv xiaofei:user:kc705_ts2asi:1.0 kc705_ts2asi_12 ]

  # Create instance: kc705_ts2asi_13, and set properties
  set kc705_ts2asi_13 [ create_bd_cell -type ip -vlnv xiaofei:user:kc705_ts2asi:1.0 kc705_ts2asi_13 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M11_AXI [get_bd_intf_pins axi4_tsp_8/s00_axi] [get_bd_intf_pins axi_interconnect_0/M11_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M12_AXI [get_bd_intf_pins axi4_tsp_9/s00_axi] [get_bd_intf_pins axi_interconnect_0/M12_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M13_AXI [get_bd_intf_pins axi4_tsp_10/s00_axi] [get_bd_intf_pins axi_interconnect_0/M13_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M14_AXI [get_bd_intf_pins axi4_tsp_11/s00_axi] [get_bd_intf_pins axi_interconnect_0/M14_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M15_AXI [get_bd_intf_pins axi4_tsp_12/s00_axi] [get_bd_intf_pins axi_interconnect_0/M15_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M16_AXI [get_bd_intf_pins axi4_tsp_13/s00_axi] [get_bd_intf_pins axi_interconnect_0/M16_AXI]
  ...
  connect_bd_net -net axi4_tsp_10_ts_out [get_bd_pins axi4_tsp_10/ts_out] [get_bd_pins kc705_ts2asi_10/din_8b]
  connect_bd_net -net axi4_tsp_10_ts_out_clk [get_bd_pins axi4_tsp_10/ts_out_clk] [get_bd_pins kc705_ts2asi_10/din_clk]
  connect_bd_net -net axi4_tsp_10_ts_out_sync [get_bd_pins axi4_tsp_10/ts_out_sync] [get_bd_pins kc705_ts2asi_10/sync]
  connect_bd_net -net axi4_tsp_10_ts_out_valid [get_bd_pins axi4_tsp_10/ts_out_valid] [get_bd_pins kc705_ts2asi_10/valid]
  connect_bd_net -net axi4_tsp_11_ts_out [get_bd_pins axi4_tsp_11/ts_out] [get_bd_pins kc705_ts2asi_11/din_8b]
  connect_bd_net -net axi4_tsp_11_ts_out_clk [get_bd_pins axi4_tsp_11/ts_out_clk] [get_bd_pins kc705_ts2asi_11/din_clk]
  connect_bd_net -net axi4_tsp_11_ts_out_sync [get_bd_pins axi4_tsp_11/ts_out_sync] [get_bd_pins kc705_ts2asi_11/sync]
  connect_bd_net -net axi4_tsp_11_ts_out_valid [get_bd_pins axi4_tsp_11/ts_out_valid] [get_bd_pins kc705_ts2asi_11/valid]
  connect_bd_net -net axi4_tsp_12_ts_out [get_bd_pins axi4_tsp_12/ts_out] [get_bd_pins kc705_ts2asi_12/din_8b]
  connect_bd_net -net axi4_tsp_12_ts_out_clk [get_bd_pins axi4_tsp_12/ts_out_clk] [get_bd_pins kc705_ts2asi_12/din_clk]
  connect_bd_net -net axi4_tsp_12_ts_out_sync [get_bd_pins axi4_tsp_12/ts_out_sync] [get_bd_pins kc705_ts2asi_12/sync]
  connect_bd_net -net axi4_tsp_12_ts_out_valid [get_bd_pins axi4_tsp_12/ts_out_valid] [get_bd_pins kc705_ts2asi_12/valid]
  connect_bd_net -net axi4_tsp_13_ts_out [get_bd_pins axi4_tsp_13/ts_out] [get_bd_pins kc705_ts2asi_13/din_8b]
  connect_bd_net -net axi4_tsp_13_ts_out_clk [get_bd_pins axi4_tsp_13/ts_out_clk] [get_bd_pins kc705_ts2asi_13/din_clk]
  connect_bd_net -net axi4_tsp_13_ts_out_sync [get_bd_pins axi4_tsp_13/ts_out_sync] [get_bd_pins kc705_ts2asi_13/sync]
  connect_bd_net -net axi4_tsp_13_ts_out_valid [get_bd_pins axi4_tsp_13/ts_out_valid] [get_bd_pins kc705_ts2asi_13/valid]
  ...
  connect_bd_net -net axi4_tsp_8_ts_out [get_bd_pins axi4_tsp_8/ts_out] [get_bd_pins kc705_ts2asi_8/din_8b]
  connect_bd_net -net axi4_tsp_8_ts_out_clk [get_bd_pins axi4_tsp_8/ts_out_clk] [get_bd_pins kc705_ts2asi_8/din_clk]
  connect_bd_net -net axi4_tsp_8_ts_out_sync [get_bd_pins axi4_tsp_8/ts_out_sync] [get_bd_pins kc705_ts2asi_8/sync]
  connect_bd_net -net axi4_tsp_8_ts_out_valid [get_bd_pins axi4_tsp_8/ts_out_valid] [get_bd_pins kc705_ts2asi_8/valid]
  connect_bd_net -net axi4_tsp_9_ts_out [get_bd_pins axi4_tsp_9/ts_out] [get_bd_pins kc705_ts2asi_9/din_8b]
  connect_bd_net -net axi4_tsp_9_ts_out_clk [get_bd_pins axi4_tsp_9/ts_out_clk] [get_bd_pins kc705_ts2asi_9/din_clk]
  connect_bd_net -net axi4_tsp_9_ts_out_sync [get_bd_pins axi4_tsp_9/ts_out_sync] [get_bd_pins kc705_ts2asi_9/sync]
  connect_bd_net -net axi4_tsp_9_ts_out_valid [get_bd_pins axi4_tsp_9/ts_out_valid] [get_bd_pins kc705_ts2asi_9/valid]
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi4_tsp_0/s00_axi_aclk] [get_bd_pins axi4_tsp_1/s00_axi_aclk] [get_bd_pins axi4_tsp_10/s00_axi_aclk] [get_bd_pins axi4_tsp_11/s00_axi_aclk] [get_bd_pins axi4_tsp_12/s00_axi_aclk] [get_bd_pins axi4_tsp_13/s00_axi_aclk] [get_bd_pins axi4_tsp_2/s00_axi_aclk] [get_bd_pins axi4_tsp_3/s00_axi_aclk] [get_bd_pins axi4_tsp_4/s00_axi_aclk] [get_bd_pins axi4_tsp_5/s00_axi_aclk] [get_bd_pins axi4_tsp_6/s00_axi_aclk] [get_bd_pins axi4_tsp_7/s00_axi_aclk] [get_bd_pins axi4_tsp_8/s00_axi_aclk] [get_bd_pins axi4_tsp_9/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] [get_bd_pins axi_interconnect_0/M11_ACLK] [get_bd_pins axi_interconnect_0/M12_ACLK] [get_bd_pins axi_interconnect_0/M13_ACLK] [get_bd_pins axi_interconnect_0/M14_ACLK] [get_bd_pins axi_interconnect_0/M15_ACLK] [get_bd_pins axi_interconnect_0/M16_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins kc705_pcie_ext_0/pcie_clk_125MHz]
  ...
  connect_bd_net -net kc705_ts2asi_10_asi_out_n [get_bd_ports asi_out_n_10] [get_bd_pins kc705_ts2asi_10/asi_out_n]
  connect_bd_net -net kc705_ts2asi_10_asi_out_p [get_bd_ports asi_out_p_10] [get_bd_pins kc705_ts2asi_10/asi_out_p]
  connect_bd_net -net kc705_ts2asi_11_asi_out_n [get_bd_ports asi_out_n_11] [get_bd_pins kc705_ts2asi_11/asi_out_n]
  connect_bd_net -net kc705_ts2asi_11_asi_out_p [get_bd_ports asi_out_p_11] [get_bd_pins kc705_ts2asi_11/asi_out_p]
  connect_bd_net -net kc705_ts2asi_12_asi_out_n [get_bd_ports asi_out_n_12] [get_bd_pins kc705_ts2asi_12/asi_out_n]
  connect_bd_net -net kc705_ts2asi_12_asi_out_p [get_bd_ports asi_out_p_12] [get_bd_pins kc705_ts2asi_12/asi_out_p]
  connect_bd_net -net kc705_ts2asi_13_asi_out_n [get_bd_ports asi_out_n_13] [get_bd_pins kc705_ts2asi_13/asi_out_n]
  connect_bd_net -net kc705_ts2asi_13_asi_out_p [get_bd_ports asi_out_p_13] [get_bd_pins kc705_ts2asi_13/asi_out_p]
  ...
  connect_bd_net -net kc705_ts2asi_8_asi_out_n [get_bd_ports asi_out_n_8] [get_bd_pins kc705_ts2asi_8/asi_out_n]
  connect_bd_net -net kc705_ts2asi_8_asi_out_p [get_bd_ports asi_out_p_8] [get_bd_pins kc705_ts2asi_8/asi_out_p]
  connect_bd_net -net kc705_ts2asi_9_asi_out_n [get_bd_ports asi_out_n_9] [get_bd_pins kc705_ts2asi_9/asi_out_n]
  connect_bd_net -net kc705_ts2asi_9_asi_out_p [get_bd_ports asi_out_p_9] [get_bd_pins kc705_ts2asi_9/asi_out_p]
  connect_bd_net -net mpeg_clk_1 [get_bd_ports mpeg_clk] [get_bd_pins axi4_tsp_0/mpeg_clk]
  connect_bd_net -net mpeg_clk_10_1 [get_bd_ports mpeg_clk_10] [get_bd_pins axi4_tsp_10/mpeg_clk]
  connect_bd_net -net mpeg_clk_11_1 [get_bd_ports mpeg_clk_11] [get_bd_pins axi4_tsp_11/mpeg_clk]
  connect_bd_net -net mpeg_clk_12_1 [get_bd_ports mpeg_clk_12] [get_bd_pins axi4_tsp_12/mpeg_clk]
  connect_bd_net -net mpeg_clk_13_1 [get_bd_ports mpeg_clk_13] [get_bd_pins axi4_tsp_13/mpeg_clk]
  ...
  connect_bd_net -net mpeg_clk_8_1 [get_bd_ports mpeg_clk_8] [get_bd_pins axi4_tsp_8/mpeg_clk]
  connect_bd_net -net mpeg_clk_9_1 [get_bd_ports mpeg_clk_9] [get_bd_pins axi4_tsp_9/mpeg_clk]
  connect_bd_net -net mpeg_data_1 [get_bd_ports mpeg_data] [get_bd_pins axi4_tsp_0/mpeg_data]
  connect_bd_net -net mpeg_data_10_1 [get_bd_ports mpeg_data_10] [get_bd_pins axi4_tsp_10/mpeg_data]
  connect_bd_net -net mpeg_data_11_1 [get_bd_ports mpeg_data_11] [get_bd_pins axi4_tsp_11/mpeg_data]
  connect_bd_net -net mpeg_data_12_1 [get_bd_ports mpeg_data_12] [get_bd_pins axi4_tsp_12/mpeg_data]
  connect_bd_net -net mpeg_data_13_1 [get_bd_ports mpeg_data_13] [get_bd_pins axi4_tsp_13/mpeg_data]
  ...
  connect_bd_net -net mpeg_data_8_1 [get_bd_ports mpeg_data_8] [get_bd_pins axi4_tsp_8/mpeg_data]
  connect_bd_net -net mpeg_data_9_1 [get_bd_ports mpeg_data_9] [get_bd_pins axi4_tsp_9/mpeg_data]
  connect_bd_net -net mpeg_sync_1 [get_bd_ports mpeg_sync] [get_bd_pins axi4_tsp_0/mpeg_sync]
  connect_bd_net -net mpeg_sync_10_1 [get_bd_ports mpeg_sync_10] [get_bd_pins axi4_tsp_10/mpeg_sync]
  connect_bd_net -net mpeg_sync_11_1 [get_bd_ports mpeg_sync_11] [get_bd_pins axi4_tsp_11/mpeg_sync]
  connect_bd_net -net mpeg_sync_12_1 [get_bd_ports mpeg_sync_12] [get_bd_pins axi4_tsp_12/mpeg_sync]
  connect_bd_net -net mpeg_sync_13_1 [get_bd_ports mpeg_sync_13] [get_bd_pins axi4_tsp_13/mpeg_sync]
  ...
  connect_bd_net -net mpeg_sync_8_1 [get_bd_ports mpeg_sync_8] [get_bd_pins axi4_tsp_8/mpeg_sync]
  connect_bd_net -net mpeg_sync_9_1 [get_bd_ports mpeg_sync_9] [get_bd_pins axi4_tsp_9/mpeg_sync]
  connect_bd_net -net mpeg_valid_1 [get_bd_ports mpeg_valid] [get_bd_pins axi4_tsp_0/mpeg_valid]
  connect_bd_net -net mpeg_valid_10_1 [get_bd_ports mpeg_valid_10] [get_bd_pins axi4_tsp_10/mpeg_valid]
  connect_bd_net -net mpeg_valid_11_1 [get_bd_ports mpeg_valid_11] [get_bd_pins axi4_tsp_11/mpeg_valid]
  connect_bd_net -net mpeg_valid_12_1 [get_bd_ports mpeg_valid_12] [get_bd_pins axi4_tsp_12/mpeg_valid]
  connect_bd_net -net mpeg_valid_13_1 [get_bd_ports mpeg_valid_13] [get_bd_pins axi4_tsp_13/mpeg_valid]
  ...
  connect_bd_net -net mpeg_valid_8_1 [get_bd_ports mpeg_valid_8] [get_bd_pins axi4_tsp_8/mpeg_valid]
  connect_bd_net -net mpeg_valid_9_1 [get_bd_ports mpeg_valid_9] [get_bd_pins axi4_tsp_9/mpeg_valid]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi4_tsp_0/s00_axi_aresetn] [get_bd_pins axi4_tsp_1/s00_axi_aresetn] [get_bd_pins axi4_tsp_10/s00_axi_aresetn] [get_bd_pins axi4_tsp_11/s00_axi_aresetn] [get_bd_pins axi4_tsp_12/s00_axi_aresetn] [get_bd_pins axi4_tsp_13/s00_axi_aresetn] [get_bd_pins axi4_tsp_2/s00_axi_aresetn] [get_bd_pins axi4_tsp_3/s00_axi_aresetn] [get_bd_pins axi4_tsp_4/s00_axi_aresetn] [get_bd_pins axi4_tsp_5/s00_axi_aresetn] [get_bd_pins axi4_tsp_6/s00_axi_aresetn] [get_bd_pins axi4_tsp_7/s00_axi_aresetn] [get_bd_pins axi4_tsp_8/s00_axi_aresetn] [get_bd_pins axi4_tsp_9/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins kc705_ts2asi_0/rst_n] [get_bd_pins kc705_ts2asi_1/rst_n] [get_bd_pins kc705_ts2asi_10/rst_n] [get_bd_pins kc705_ts2asi_11/rst_n] [get_bd_pins kc705_ts2asi_12/rst_n] [get_bd_pins kc705_ts2asi_13/rst_n] [get_bd_pins kc705_ts2asi_2/rst_n] [get_bd_pins kc705_ts2asi_3/rst_n] [get_bd_pins kc705_ts2asi_4/rst_n] [get_bd_pins kc705_ts2asi_5/rst_n] [get_bd_pins kc705_ts2asi_6/rst_n] [get_bd_pins kc705_ts2asi_7/rst_n] [get_bd_pins kc705_ts2asi_8/rst_n] [get_bd_pins kc705_ts2asi_9/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x8100C000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi4_tsp_10/s00_axi/reg0] SEG_axi4_tsp_10_reg0
  create_bd_addr_seg -range 0x1000 -offset 0x8100D000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi4_tsp_11/s00_axi/reg0] SEG_axi4_tsp_11_reg0
  create_bd_addr_seg -range 0x1000 -offset 0x8100E000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi4_tsp_12/s00_axi/reg0] SEG_axi4_tsp_12_reg0
  create_bd_addr_seg -range 0x1000 -offset 0x8100F000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi4_tsp_13/s00_axi/reg0] SEG_axi4_tsp_13_reg0
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x8100A000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi4_tsp_8/s00_axi/reg0] SEG_axi4_tsp_8_reg0
  create_bd_addr_seg -range 0x1000 -offset 0x8100B000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi4_tsp_9/s00_axi/reg0] SEG_axi4_tsp_9_reg0
