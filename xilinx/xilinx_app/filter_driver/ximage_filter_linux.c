...
int XImage_filter_Initialize(XImage_filter *InstancePtr, const char* InstanceName) {
	...
	InstancePtr->size = 0x10000;
	int fd = open("/dev/mem", O_RDWR);
	InstancePtr->Control_bus_BaseAddress = (u32)mmap(NULL, InstancePtr->size, PROT_READ|PROT_WRITE, MAP_SHARED, fd, (off_t)0x6ee00000);
	assert(InstancePtr->Control_bus_BaseAddress);
...
int XImage_filter_Release(XImage_filter *InstancePtr) {
	...
	munmap((void*)InstancePtr->Control_bus_BaseAddress, InstancePtr->size);
