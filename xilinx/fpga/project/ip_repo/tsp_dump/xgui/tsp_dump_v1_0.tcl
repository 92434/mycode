...
proc init_gui { IPINST } {
  ...
  set MPEG_DATA_WIDTH  [  ipgui::add_param $IPINST -name "MPEG_DATA_WIDTH" -parent ${Page_0} -display_name {Mpeg Data Width}]
  set_property tooltip {Mpeg Data Width} ${MPEG_DATA_WIDTH}
