...
proc init_gui { IPINST } {
  ...
  set C_S00_AXI_BUSER_WIDTH  [  ipgui::add_param $IPINST -name "C_S00_AXI_BUSER_WIDTH" -parent ${Page_0} -display_name {C S00 Axi Buser Width}]
  set_property tooltip {C S00 Axi Buser Width} ${C_S00_AXI_BUSER_WIDTH}
  set C_S00_AXI_RUSER_WIDTH  [  ipgui::add_param $IPINST -name "C_S00_AXI_RUSER_WIDTH" -parent ${Page_0} -display_name {C S00 Axi Ruser Width}]
  set_property tooltip {C S00 Axi Ruser Width} ${C_S00_AXI_RUSER_WIDTH}
  set C_S00_AXI_WUSER_WIDTH  [  ipgui::add_param $IPINST -name "C_S00_AXI_WUSER_WIDTH" -parent ${Page_0} -display_name {C S00 Axi Wuser Width}]
  set_property tooltip {C S00 Axi Wuser Width} ${C_S00_AXI_WUSER_WIDTH}
  set C_S00_AXI_ARUSER_WIDTH  [  ipgui::add_param $IPINST -name "C_S00_AXI_ARUSER_WIDTH" -parent ${Page_0} -display_name {C S00 Axi Aruser Width}]
  set_property tooltip {C S00 Axi Aruser Width} ${C_S00_AXI_ARUSER_WIDTH}
  set C_S00_AXI_AWUSER_WIDTH  [  ipgui::add_param $IPINST -name "C_S00_AXI_AWUSER_WIDTH" -parent ${Page_0} -display_name {C S00 Axi Awuser Width}]
  set_property tooltip {C S00 Axi Awuser Width} ${C_S00_AXI_AWUSER_WIDTH}
  ...
  set C_S00_AXI_ID_WIDTH  [  ipgui::add_param $IPINST -name "C_S00_AXI_ID_WIDTH" -parent ${Page_0} -display_name {C S00 Axi Id Width}]
  set_property tooltip {C S00 Axi Id Width} ${C_S00_AXI_ID_WIDTH}
