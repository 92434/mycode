...
proc update_PARAM_VALUE.TSP_FILTER_NUM { PARAM_VALUE.TSP_FILTER_NUM } {
	# Procedure called to update TSP_FILTER_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TSP_FILTER_NUM { PARAM_VALUE.TSP_FILTER_NUM } {
	# Procedure called to validate TSP_FILTER_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.TSP_FILTER_NUM { MODELPARAM_VALUE.TSP_FILTER_NUM PARAM_VALUE.TSP_FILTER_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TSP_FILTER_NUM}] ${MODELPARAM_VALUE.TSP_FILTER_NUM}
}
