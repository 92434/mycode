...
proc init_gui { IPINST } {
  ...
  set C_M00_AXIS_START_COUNT  [  ipgui::add_param $IPINST -name "C_M00_AXIS_START_COUNT" -parent ${Page_0} -display_name {C_M00_AXIS_START_COUNT}]
  set_property tooltip {C_M00_AXIS_START_COUNT} ${C_M00_AXIS_START_COUNT}
  set C_M00_AXIS_TDATA_WIDTH  [  ipgui::add_param $IPINST -name "C_M00_AXIS_TDATA_WIDTH" -parent ${Page_0} -display_name {C_M00_AXIS_TDATA_WIDTH}]
  set_property tooltip {C_M00_AXIS_TDATA_WIDTH} ${C_M00_AXIS_TDATA_WIDTH}
