...
proc create_root_design { parentCell } {
  ...
  set iic_scl [ create_bd_port -dir I iic_scl ]
  ...
  # Create instance: iic_slave_0, and set properties
  set iic_slave_0 [ create_bd_cell -type ip -vlnv xiaofei:user:iic_slave:1.0 iic_slave_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins iic_slave_0/s00_axi]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins iic_slave_0/iic_rst_n] [get_bd_pins iic_slave_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  connect_bd_net -net Net [get_bd_ports iic_sda] [get_bd_pins iic_slave_0/iic_sda]
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins iic_slave_0/iic_clk] [get_bd_pins iic_slave_0/s00_axi_aclk] [get_bd_pins kc705_pcie_ext_0/pcie_clk_125MHz]
  ...
  connect_bd_net -net iic_scl_1 [get_bd_ports iic_scl] [get_bd_pins iic_slave_0/iic_scl]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_pcie_0/INTX_MSI_Request] [get_bd_pins axi_pcie_0/MSI_Vector_Num] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x81001000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs iic_slave_0/s00_axi/reg0] SEG_iic_slave_0_reg0
