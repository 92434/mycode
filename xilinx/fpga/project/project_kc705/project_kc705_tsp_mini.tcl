...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_MI {10} CONFIG.NUM_SI {7}  ] $axi_interconnect_0
  ...
  connect_bd_intf_net -intf_net asi_dump_0_m00_axis [get_bd_intf_pins asi_dump_0/m00_axis] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_gpio_3/S_AXI] [get_bd_intf_pins axi_interconnect_0/M07_AXI]
  ...
  connect_bd_intf_net -intf_net tsp_dump_0_m00_axis [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins tsp_dump_0/m00_axis]
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins asi_dump_0/m00_axis_aclk] [get_bd_pins axi4_tsp_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_interconnect_0/S05_ACLK] [get_bd_pins axi_interconnect_0/S06_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins intr_hub_0/clk] [get_bd_pins kc705_i2s_receiver_0/m00_axis_aclk] [get_bd_pins kc705_pcie_ext_0/pcie_clk_125MHz] [get_bd_pins kc705_ts2asi_0/clk] [get_bd_pins myip_i2s_sender_0/clk] [get_bd_pins tsp_dump_0/m00_axis_aclk]
  ...
  connect_bd_net -net kc705_ts2asi_0_ce [get_bd_pins asi_dump_0/ts_clk] [get_bd_pins kc705_ts2asi_0/ce]
  connect_bd_net -net kc705_ts2asi_0_sout_data [get_bd_pins asi_dump_0/ts_data] [get_bd_pins kc705_ts2asi_0/sout_data]
  connect_bd_net -net kc705_ts2asi_0_ts_clk [get_bd_pins kc705_ts2asi_0/ts_clk] [get_bd_pins tsp_dump_0/ts_clk]
  connect_bd_net -net kc705_ts2asi_0_ts_data [get_bd_pins kc705_ts2asi_0/ts_data] [get_bd_pins tsp_dump_0/ts_data]
  connect_bd_net -net kc705_ts2asi_0_ts_sync [get_bd_pins kc705_ts2asi_0/ts_sync] [get_bd_pins tsp_dump_0/ts_sync]
  connect_bd_net -net kc705_ts2asi_0_ts_valid [get_bd_pins kc705_ts2asi_0/ts_valid] [get_bd_pins tsp_dump_0/ts_valid]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins asi_dump_0/m00_axis_aresetn] [get_bd_pins axi4_tsp_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins intr_hub_0/rst] [get_bd_pins kc705_i2s_receiver_0/m00_axis_aresetn] [get_bd_pins kc705_ts2asi_0/rst_n] [get_bd_pins myip_i2s_sender_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins tsp_dump_0/m00_axis_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x80020000 [get_bd_addr_spaces axi_dma_2/Data_MM2S] [get_bd_addr_segs axi_pcie_0/S_AXI/BAR2] SEG_axi_pcie_0_BAR2
  create_bd_addr_seg -range 0x10000 -offset 0x80020000 [get_bd_addr_spaces axi_dma_2/Data_S2MM] [get_bd_addr_segs axi_pcie_0/S_AXI/BAR2] SEG_axi_pcie_0_BAR2
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x81006000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x81005000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg
