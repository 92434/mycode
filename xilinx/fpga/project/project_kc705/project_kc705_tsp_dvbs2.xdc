...
#FMC_HPC_HA22_N
set_property PACKAGE_PIN K11 [get_ports {gpio_tri_io[12]}]
set_property IOSTANDARD LVCMOS15 [get_ports {gpio_tri_io[12]}]

#FMC_HPC_HA22_P
set_property PACKAGE_PIN L11 [get_ports {gpio_tri_io[13]}]
set_property IOSTANDARD LVCMOS15 [get_ports {gpio_tri_io[13]}]

#FMC_HPC_HA18_N
set_property PACKAGE_PIN J14 [get_ports {gpio_tri_io[14]}]
set_property IOSTANDARD LVCMOS15 [get_ports {gpio_tri_io[14]}]

#FMC_HPC_HA18_P
set_property PACKAGE_PIN K14 [get_ports {gpio_tri_io[15]}]
...
#FMC_HPC_LA20_P
set_property PACKAGE_PIN E19 [get_ports {mpeg_data[5]}]
set_property IOSTANDARD LVCMOS15 [get_ports {mpeg_data[5]}]

#FMC_HPC_LA20_N
set_property PACKAGE_PIN D19 [get_ports {mpeg_data[6]}]
set_property IOSTANDARD LVCMOS15 [get_ports {mpeg_data[6]}]

#FMC_HPC_LA22_P
set_property PACKAGE_PIN C20 [get_ports {mpeg_data[7]}]
set_property IOSTANDARD LVCMOS15 [get_ports {mpeg_data[7]}]

#FMC_HPC_LA30_N
set_property PACKAGE_PIN C22 [get_ports {mpeg_sync}]
