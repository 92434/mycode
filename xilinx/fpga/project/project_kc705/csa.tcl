...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CSA_CALC_INST_NUM {4} CONFIG.C_S00_AXI_ADDR_WIDTH {12} CONFIG.NUMBER_OF_INPUT_WORDS {5} CONFIG.NUMBER_OF_OUTPUT_WORDS {7}  ] $kc705_csa_0
